...
import  chestiron from '../assets/cheststone.PNG'


export default function ThirdtCase ({id , title , price, state}) {

    
  const chest = {id: 3, name: 'Cooper', price:1000}
...
// save inventory to localstorage
    ...
    return (
            ...
            style={{display:'flex', flexDirection:'column', width: '900px',textAlign:"center", marginLeft:'280px'}}>
                ...
                >{}</p>  
                <p>{}</p>
                <img src="src/assets/cooperchest.PNG" alt="" />
