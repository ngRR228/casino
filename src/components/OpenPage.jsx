...
export default function OpenPage ({id , title , price}) {

  const chests = [{id: 1, name: 'Wooden', price:10}, {id:2, name:"Stone", price: 100}, {id:3, name:"Cooper", price:1000}, {id:4, name:"Iron", price:10000}, {id:5, name:"Golden", price: 100000}]
...
// save inventory to localstorage
    ...
    return (
            ...
            style={{display:'flex', flexDirection:'column', width: '900px',textAlign:"center", marginLeft:'280px'}}>
                ...
                >{}</p>  
                <p>{}</p>
                <img src="/src/assets/chest.png" alt="" />
...
{/* <div className="test">
    <ul>{imagePrizes.map((image, index) => (
        <li> <img src = {image} key={index} img/> </li>
        ))} </ul>
</div> */}



{/* roulette code with emoji 

<div className="roulette-window">
    <div className='prize-line' style={{transform: `translateX(${offset}px)`}}
    >{fullPrizes.map((emoji,index) => (
        
        <div className="result" key={index}>{emoji}</div>
